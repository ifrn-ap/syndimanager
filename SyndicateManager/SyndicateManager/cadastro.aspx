<%@ Page Title="" Language="C#" MasterPageFile="~/Master Page.Master" AutoEventWireup="true"
    CodeBehind="cadastro.aspx.cs" Inherits="SyndicateManager.cadastro" MaintainScrollPositionOnPostback="true"%>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cphConteudo" runat="server">
    ...
    <div id="formulario">
        ...
        <div class="botoes">
            <asp:Button ID="btnCadastrar" runat="server" Text="Cadastrar" Width="75px" 
                CssClass="button" onclick="btnCadastrar_Click" />
            <asp:Button ID="btnLimpar" runat="server" Text="Limpar" Width="75px" 
                CssClass="button" onclick="btnLimpar_Click" />
            </div>
